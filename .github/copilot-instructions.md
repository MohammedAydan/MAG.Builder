...
- Use this file as always-on repository instructions.
- For TypeScript/Next.js work, also follow `.github/instructions/nextjs.instructions.md`.
- For security-sensitive work, also follow `.github/instructions/security.instructions.md`.
- For builder work, also follow `.github/instructions/builder.instructions.md`.
- For commerce work, also follow `.github/instructions/commerce.instructions.md`.
