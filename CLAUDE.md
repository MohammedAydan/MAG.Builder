...
Claude Code should load this file as project memory. Use it as the persistent project instruction file. Do not rely on chat-only instructions for architecture rules.
