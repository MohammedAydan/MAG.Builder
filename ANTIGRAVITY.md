...
## Tool notes: Google Antigravity

Use `.antigravity/rules.md` and `.agent/workflows/` for workspace rules and reusable workflows. Start with review-driven development and restricted terminal permissions.
