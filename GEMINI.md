...
Gemini CLI should use this file as project memory/context. If context is not loaded, run `/memory show` or reload the session and explicitly attach this file.
