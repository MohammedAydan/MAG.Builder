    ...
    <div className="space-y-6">
      <section className="rounded-[2rem] border border-white/70 bg-white/85 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-600 sm:text-base">
          The dashboard has been expanded into a full Admin Control Center. It now provides
          focused management surfaces for sites, commerce, forms, automation, integrations,
          and marketplace modules, all while maintaining strict server-enforced permissions.
        </p>
      </section>
