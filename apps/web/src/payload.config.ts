 ...
 * commands (generate:types, generate:importmap) can run without a live database
 * connection. A missing PAYLOAD_SECRET in production will cause Payload to fail
