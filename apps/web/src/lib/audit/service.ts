...
export const AUDIT_ACTIONS = {
  ...
  automationRuleExecuted: 'automation.rule.executed',
  ...
  pluginMigrationPlanned: 'plugins.migrations.planned',
  searchReindexed: 'search.reindexed',
  templateDemoImported: 'templates.demo.imported',
  templateExported: 'templates.exported',
  templateImported: 'templates.imported',
